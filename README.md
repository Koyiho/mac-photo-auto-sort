...
Homebrew + exiftool 설치
~/Scripts/organize_photos.sh 스크립트 저장
Automator로 Folder Action 생성 → PhotoInbox 폴더에 연결
PhotoInbox에 사진을 넣으면 자동으로 PhotoSorted/연도/월/일에 정리됨

맥 초기화 후 재설정할 때

이 저장소를 클론(또는 맥 사진 자동분류 설정 가이드.md 다운로드) 한 뒤,
